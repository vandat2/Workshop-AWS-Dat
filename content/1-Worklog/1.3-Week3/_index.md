...
| 5   | - Complete module qa_service.py to connect retriever, prompt, and generator.<br />- Create a chat interface using Chainlit in app.py.                                                                               | 09/07/2026 | 09/07/2026      |                                                                                                                                                                         |
| 6   | - Learn application architecture running on Amazon EC2.<br />- Design an initial AWS architecture diagram with ALB, EC2, RDS pgvector, and Bedrock.                                                                 | 10/07/2026 | 10/07/2026      | [aws.amazon.com/vi/elasticloadbalancing/application-load-balancer](https://aws.amazon.com/vi/elasticloadbalancing/application-load-balancer/)<br />aws.amazon.com/vi/ec2 |
...
- Initial AWS architecture design for the system is available.
