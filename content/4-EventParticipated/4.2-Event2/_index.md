...
- Share experiences from the hands-on Hackathon competition, where teams collaborated to build Agentic AI products.
- Drive the adoption of cloud technologies to modernize architecture, focusing on solving real-world enterprise pain points.
- Inspire technology product development through pitching sessions from competing teams.
...
Throughout the presentations, the competing teams identified several critical bottlenecks in existing systems:

- **Disrupted User Experience (Team One Team):** Forcing customers to download a new app, create an account, and leave their familiar chat interface to place orders creates friction, causing businesses to easily lose potential customers.
- **Fragmented Strategic Data (Team Signal Scout):** Business signals and competitor strategic data are often scattered across various reports. Analysts face difficulties synthesizing data to project ROI when transforming business models.
...
Through the teams' defense sessions, it became clear that starting from a specific user problem helps define a clearer development direction than beginning with a new technology and then searching for applications. Teams that spent time observing and understanding their target customers before writing code were the most successful.
...
- **Practicality of Cloud Computing:** Gained a clearer understanding of how teams flexibly integrated AWS services such as Lambda, Kinesis, DynamoDB, and Amazon Bedrock to ensure seamless performance at optimal cost.

### Application to Work & Study

Learning project scoping and pitching skills from the competing teams to better prepare for practical phases in the AWS FCAJ program and upcoming Hackathon competitions.
